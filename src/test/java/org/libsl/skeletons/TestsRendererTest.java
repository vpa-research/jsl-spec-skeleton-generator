...
import org.libsl.skeletons.rendering.InfoRendererTests;
...
class TestsRendererTest {
    ...
    void render(final String target) throws IOException {
        final String targetSrc = TestUtils.loadExampleFile("skeletons/tests/" + target + ".txt");
        ...
        try (PrintStream ps = new PrintStream(baos, true, StandardCharsets.UTF_8)) {
            new InfoRendererTests(summary, new PrettyPrinter(ps)).render();
        }
